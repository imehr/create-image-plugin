...
export class ConfigLoader {
  ...
  private cachedConfig?: GlobalConfig;
   ...
   */
  private loadYAMLConfig(filePath: string): Partial<GlobalConfig> {
   ...
   */
  private discoverProvidersFromEnv(): ProviderConfig[] {
